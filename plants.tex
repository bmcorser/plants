...
(more ``lowly''?) formality; the thing presented is something that is
wonderfully done, with smooth motion and perfect counterbalance, but
constructed entirely from little sticks of bamboo, string, elastic bands and
powered by trickle of a mountain stream; it is such a brilliant idea that no
one would actually think to do it.

It is comical too, like our hero from Chapter~\ref{chapter:cornered-nature-1},
but the comedy in our fake is expressed with childlike mannerism.
