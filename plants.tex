...
what arrived on stage before what (whatever the case, \emph{we} are the late
ones!). Thanks to our Victorian-Germanic imperative to suffuse narrative into
the banal, it is this question that bounds eagerly to the forefront of our
considerations.

We have a need to discover which thing is more the innocent party,
to find out what fetched up amongst its neighbours without the language to
articulate what its fetching up could mean (for it or for them). And conversely
what arrived not strictly of its own accord, but somewhat ``designed'' for some
particular task or set of purposes.
