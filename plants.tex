...
its delicate spread of antennae are placed well out of arm's reach, the
culturally requisite lucky charms are added.
...
could find safety to emerge into.
...
shoulders. This is motion without destination, as with ilynx and vertigo.
...
activity (otherwise known as ``work''). This evidence appears as the
side-effect of a serious process, not as a direct mark. It arrives due to the
neccesity of silencing the pleas for attendance from smaller details in favour
of the needs of larger work that is taking place.
