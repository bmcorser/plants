...
subject.  It shortcuts through formality using \uline{an} \uline{other}
formality; the thing presented is something that is wonderfully done, with
smooth motion and perfect counterbalance, but constructed entirely from little
sticks and elastic bands, powered by trickle of a mountain stream; such a
brilliant idea that no one would do it.
