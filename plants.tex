...
sure, but more of possessing a strange heroism; it is engaged in an odd battle
against elegance.
...
Part of the magic of the pre-made is that it appears to have come from nowhere
and seems to have always been there.

Prefab forces us to interrogate everything in the scene in order to find out
what arrived there before what. For some reason, that question becomes
important. We need to discover which thing is the more innocent party, what
fetched up amongst its neighbours without the language to articulate what that
fetching up could mean. And conversely what arrived not strictly of its own
accord, but ``designed'' for some particular task or pre-conceived set of
purposes.

Already, in the off-kilter tone of the initial question, we find ourselves
essentially considering (when presented with this certain arrangement) which
thing out of those offered is ``most'' prefabricated. Thusly, they are set in
